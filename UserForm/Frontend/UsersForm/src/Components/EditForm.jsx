...
useEffect(()=>{
    ...
    async function getuserData() {
        ...
        let response=await fetch(`http://localhost:3000/api/v1/finduser/${id}`)
      ...
      >
        ...
        <div className="space-y-6">
          ...
          <motion.button
            ...
            className="w-full cursor-pointer bg-gradient-to-r from-pink-500 to-purple-500 text-white py-3 rounded-lg font-bold uppercase tracking-wider shadow-lg hover:shadow-2xl transition duration-300 transform hover:scale-105"
          >
            Update User 🚀
          </motion.button>
        </div>
